...
public class ledControl extends Activity  {
    ...
    ToggleButton targetStartButton;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //call the widgtes
        targetStartButton=(ToggleButton)findViewById(R.id.toggleButton2);
...
//        btnOff = (Button)findViewById(R.id.button3);
        ...
        targetStartButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
