...
//        }
    ...
    private void initUIControls() {
        ...
        Button BTButton = (Button) findViewById(R.id.btn_BT);
    ...
    class SensorThread extends Thread {
        ...
        public void run() {
            ...
            mSensorManager.registerListener(msl, mSensor, SensorManager.SENSOR_DELAY_GAME);
            Looper.loop();
        }
        ...
        private class MySensorListener implements SensorEventListener {
            ...
            public void onSensorChanged(SensorEvent sensorEvent) {
                ...
                // 이부분에 데이터 교환만 넣어주면 될듯
                // dataSender.sendText(degree+"e",sendDataObserver);

                //  ChangeData.setChangeValue(degree + "e");

                // if(connectTrue) dataHandler.sendText();
                // if(checkOn)
                MainValue.setMainValue(degree+"e");
